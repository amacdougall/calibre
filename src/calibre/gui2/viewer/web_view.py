...
class ViewerBridge(Bridge):
    ...
    report_anki_sentence = from_js(object, object)
    choose_anki_candidate = from_js(object, object)
    relookup_anki_candidates = from_js(object, object)
    ...
    extract_anki_sentence = to_js()
    show_anki_candidates = to_js()
    update_anki_candidates = to_js()
    goto_toc_node = to_js()
    goto_cfi = to_js()
...
class WebView(QWebEngineView):
    ...
    report_anki_sentence = pyqtSignal(object, object)
    choose_anki_candidate = pyqtSignal(object, object)
    relookup_anki_candidates = pyqtSignal(object, object)
    ...
    def __init__(self, parent=None):
        ...
        self.bridge.report_anki_sentence.connect(self.report_anki_sentence)
        self.bridge.choose_anki_candidate.connect(self.choose_anki_candidate)
        self.bridge.relookup_anki_candidates.connect(self.relookup_anki_candidates)
